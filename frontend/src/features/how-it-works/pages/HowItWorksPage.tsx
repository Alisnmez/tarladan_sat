...
function HowItWorksPage() {
  return (
    <div className="how-it-works">
      <SiteNavbar activePage="how-it-works" />
            ...
            <div className="how-cta__banner">
              <div className="how-cta__copy">
                ...
                <div className="how-cta__actions">
                  <a className="how-cta__btn how-cta__btn--primary" href="#/register">
                    Alıcı Olarak Kaydol
                  </a>
                  <a
      ...
      <footer className="how-footer">
        <div className="how-footer__inner">
          ...
          <div className="how-footer__links">
            ...
            <a href="#/how-it-works">Sürdürülebilirlik</a>
            <a href="#/register">Üretici Ol</a>
      ...
      <nav className="how-mobile-nav" aria-label="Mobil menü">
        ...
        <a className="how-mobile-nav__link--active" href="#/how-it-works">
